...
public:
    ...
    Adjacency *DFSRecur(int v,bool visited[],Adjacency* stack)
    {
        visited[v] = true;
        ...
        for (int i = 0 ; i < this->adj[v].getSize() ; i++)
        {
            ...
            {
                DFSRecur(this->adj[v].getElement(i),visited,stack);
            }
        }
        return stack;
    }
    Adjacency *DFS(int v)
    {
        ...
        // list<int> stack;
        Adjacency* stack = new Adjacency();
        return DFSRecur(v,visited,stack);
